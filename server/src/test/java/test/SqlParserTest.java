...
public class SqlParserTest {
	...
	public static void main(String[] args) throws JSQLParserException {
		...
		dataProfiles.add(new DataProfileItem("account_id", new String[]{"1001","10002"}));
		dataProfiles.add(new DataProfileItem("app_id", new String[]{"1001"}));
		dataProfiles.add(new DataProfileItem("seller_id", new String[]{"9999"}));
